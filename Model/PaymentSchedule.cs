...
namespace LSS.Model
{
    public class PaymentSchedule
    {
        ...
        public PaymentSchedule(string month, double upb_amount, double monthly_payment, double interest_amount, double principal_amount, double escrow, double late_fee, double e_principal, double suspense, double other_fee, double extra_escrow, double nsf)
        {
            this.month = month;
